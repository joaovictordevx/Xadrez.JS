...
pecas[6] = new Peca(cor2, linhas[0], colunas[4  ], alturaPecaPadrao, larguraPecaPadrao, "rei_preto", 'rei_preto.png', "rei", 6, 0);
pecas[7] = new Peca(cor2, linhas[0], colunas[3], alturaPecaPadrao, larguraPecaPadrao, "rainha_preto", 'rainha_preta.png', "rainha", 7, 0);
...
function vencerPeao(pecaAnalisada, pecaClicada) {
    ...
    if (
        ...
        permitirMovimento = true;
    } else if (objPecaClicada.cor == cor1 && pecaAnalisada.cor == cor2) {
        permitirMovimento = true;
    } else if (objPecaClicada.cor == cor2 && pecaAnalisada.cor == cor1) {
        permitirMovimento = true;
    }

    console.log("function vencerPeao")
...
function vencerCavalo(pecaAnalisada, pecaClicada) {
    ...
    let numVetorColunaPecaAnalisada = colunas.indexOf(pecaAnalisada.coluna);
    let numVetorLinhaPecaAnalisada = linhas.indexOf(pecaAnalisada.linha);
    if (objPecaClicada.cor == cor1 && pecaAnalisada.cor == cor2) {
        permitirMovimento = true;
    } else if (objPecaClicada.cor == cor2 && pecaAnalisada.cor == cor1) {
        permitirMovimento = true;
    }
...
function vencerTorre (pecaAnalisada, pecaClicada) {
    let permitirMovimento = false;
    let numVetorLinhaPecaClicada = linhas.indexOf(pecas[pecaClicada.dataset.indexNumber].linha);
    let numVetorColunaPecaClicada = colunas.indexOf(pecas[pecaClicada.dataset.indexNumber].coluna);
    let corPecaClicada = colunas.indexOf(pecas[pecaClicada.dataset.indexNumber].cor);
...
function vencerBispo (pecaAnalisada, pecaClicada) {
    let permitirMovimento = false;
    let numVetorLinhaPecaClicada = linhas.indexOf(pecas[pecaClicada.dataset.indexNumber].linha);
    let numVetorColunaPecaClicada = colunas.indexOf(pecas[pecaClicada.dataset.indexNumber].coluna);
    let corPecaClicada = colunas.indexOf(pecas[pecaClicada.dataset.indexNumber].cor);
...
function vencerRei (pecaAnalisada, pecaClicada) {
    let permitirMovimento = false;
    let numVetorLinhaPecaClicada = linhas.indexOf(pecas[pecaClicada.dataset.indexNumber].linha);
    let numVetorColunaPecaClicada = colunas.indexOf(pecas[pecaClicada.dataset.indexNumber].coluna);
    let corPecaClicada = colunas.indexOf(pecas[pecaClicada.dataset.indexNumber].cor);
        ...
        try {
            ...
            switch (pecaAnalisada.tipo) {
                ...
                case "cavalo":
                    ...
                    break;
                case "bispo":
                    permitirMovimento = vencerBispo(pecas[nVetorElementoDestino], pecaClicada);
                    break;
                case "rei":
                    permitirMovimento = vencerRei(pecas[nVetorElementoDestino], pecaClicada);
                    break;
                default:
                ...
                if (corPermitida != pecas[nVetorElementoDestino].cor) {
                    ...
                    switch (pecas[nVetorElementoDestino].tipo) {
                        ...
                        case "cavalo":
                            ...
                            break;
                        case "torre":
                            permitirMovimento = vencerTorre(pecas[nVetorElementoDestino], pecaClicada);
                            break;
                        case "bispo":
                            permitirMovimento = vencerBispo(pecas[nVetorElementoDestino], pecaClicada);
                            break;
